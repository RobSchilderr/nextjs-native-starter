        ...
        <div className="relative isolate overflow-hidden">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              <h1 className="text-base font-semibold lg:hidden leading-7 text-gray-900">
                NextJS Native
              </h1>
              <h1 className="text-base font-semibold hidden lg:block leading-7 text-gray-900">
                Cashflow
              </h1>
              ...
              <a
                href="#"
                className="ml-auto flex items-center gap-x-1 rounded-md bg-indigo-600 px-3 py-2 text-sm   text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
